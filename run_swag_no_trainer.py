...
def main():
    ...
    with accelerator.main_process_first():
        half_processed_datasets = raw_datasets.map(preprocess_0, remove_columns=raw_datasets['train'].column_names.remove("question"))
        processed_datasets = half_processed_datasets.map(
            preprocess_function, batched=True, remove_columns=half_processed_datasets['train'].column_names
        )
